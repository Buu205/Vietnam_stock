...
Examples:
  ...
  python extract_forecast_from_pdf.py --list-models
    ...
    # Set output path - save to source-specific extracted folder
    raw_forecast_dir = Path("/Users/buuphan/Dev/Vietnam_dashboard/DATA/raw/forecast")
    source_dir = raw_forecast_dir / args.source / "extracted"
    source_dir.mkdir(parents=True, exist_ok=True)
    output_path = args.output or str(source_dir / f"{args.source}_raw.json")
